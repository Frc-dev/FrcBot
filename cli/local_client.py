from cli.talk_interfaces import CLIInterface
from cli.bot_interaction import handle_recommendation_command, handle_settings_command, handle_feedback_command
from session_manager import set_local_flag
